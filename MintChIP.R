load("C:/Users/songdongyuan/group02_final_project_packet/MintChIP.RData")
workdir <- "C:/Users/songdongyuan/group02_final_project_packet"
setwd(workdir)


source("https://bioconductor.org/biocLite.R")
suppressMessages(biocLite("DiffBind"))
...
# Correlation heatmap based on the affnity scores
...
jpeg(filename = "H3K4me3_volcano.jpeg",width = 800, quality = 100)
...
# affinity heatmap
jpeg(filename = "H3K27ac_heat_affinity.jpeg",width = 800, quality = 100)
...
df_HH <- data.frame(seqnames=seqnames(design.DB),
                    ...
                    Fold=design.DB$Fold)
write.table(df_HH, file="C:/Users/songdongyuan/group02_final_project_packet/H3K4me3_DB_motif.csv", 
...
write.table(df_222, file="C:/Users/songdongyuan/group02_final_project_packet/H3K27ac_DB_motif.csv", 
            quote=F, sep="\t", row.names=F, col.names=F)
